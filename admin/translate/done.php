        ...
        <div class="col m6 s12 offset-m3">
          <div class="card">
            <div class="card-content center">
              <p class="flow-text">Go you! Your translation has been <?php if($_GET['status'] == "update") { ?>updated<?php } else { ?>added<?php } ?>. Wanna see how it looks? Click <a href="<?php echo($baseurl); ?>trail/?id=<?php echo($_GET['id']); ?>&lang=<?php echo($_GET['lang']); ?>">here</a> to see it in action.</p>
            </div>
