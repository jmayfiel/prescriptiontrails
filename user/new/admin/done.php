        ...
        <div class="col m6 s12 offset-m3">
          <div class="card">
            <div class="card-content center">
              <h4>Go you!</h4>
              <p class="flow-text">A new Prescription Trails administrator has been created.</p>
                <div class="card-panel orange darken-1">
                  <span class="white-text">Please advise the new user to check their email address, <?php echo(htmlspecialchars($_GET['e'], ENT_COMPAT, 'UTF-8')); ?>, for a verificaiton email. They must verify to access all Prescription Trails features.</span>
                </div>
              <p class="center-align" style="margin-top:15px;"><a class="btn waves-effect waves-light blue darken-1" href="<?php echo($baseurl); ?>admin/">Dashboard</a></p>
            </div>
          </div>
        </div>
